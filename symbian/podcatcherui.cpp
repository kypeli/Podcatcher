...
{
    m_pManager = PodcastManager::getInstance(this);
    ...
    connect(m_pManager, SIGNAL(showInfoDialog(QString)),
            this, SIGNAL(showInfoDialog(QString)));
    connect(m_pManager, SIGNAL(dismissInfoDialog()),
            this, SIGNAL(dismissInfoDialog()));
...
void PodcatcherUI::onPlayPodcast(int channelId, int index)
{
    ...
    launchMusicPlayer(file);

}

void PodcatcherUI::launchMusicPlayer(QUrl file)
{
#ifdef Q_OS_LINUX
